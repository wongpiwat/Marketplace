...
?>
@endforeach
<p><a href="/support/{{$market->id}}">Q&A: {{$market->name}}</a><span> > </span> <span>{{ $webboard->topic }}</span></p>
<div class="card">
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="/support/{{ $market->id }}/{{ $webboard->id }}/addReplySupport" method="post">
          <p>Comment </p>
            <div class="">
...
<div class="modal-content">
  ...
  <div class="modal-body">
  <form action="/support/{{ $market->id }}/{{ $webboard->id }}/updateComment" method="post">
...
<div class="modal fade" id="EditTopicModal" role="dialog">
    ...
    <form action='/support/{{ $market->id }}/{{ $webboard->id }}/updateTopic' method="post">
    {{ csrf_field() }}
    {{ $errors->first('name') }}
        <div class="">
        <label> Topic: </label>
